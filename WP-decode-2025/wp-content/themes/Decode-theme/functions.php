<?php
/* Toute la logique du thème */

add_action('wp_enqueue_scripts', 'decode_enqueue_styles');
function decode_enqueue_styles()
{
    wp_enqueue_style('main', get_stylesheet_uri());
}

add_action('after_setup_theme', 'decode_after_setup_theme');
function decode_after_setup_theme()
{
    add_theme_support('custom-logo');
    add_theme_support('post-thumbnails');
    register_nav_menus(
        [
            'main-menu' => __('Menu Principal', 'decode')
        ]
    );
}
